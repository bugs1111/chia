...
echo "--== $MSG ==--"
echo ""
cd $CHIAROOT && . ./activate && nohup chia plots create -f $FK -p $PK -k 32 -b 3200 -r 4 -n 999 -t /mnt/t$2/q$3 -d /mnt/d$2 > $FILE &

# cd $CHIAROOT && . ./activate && nohup ping baidu.com > ~/chia/logs/$FILE &
